...
from ariths_gen.multi_bit_circuits.multipliers import UnsignedCarrySaveMultiplier
...
multiplier = UnsignedCarrySaveMultiplier(a = a, b = b)

# Save to a file
with open("cmu16.v", "w") as f:
